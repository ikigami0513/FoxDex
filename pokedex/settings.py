...
SECRET_KEY = 'django-insecure-d9y1l+ta$b1amhou#4(juh9z)r+8fc_fs7e_+0oqp+mah=yg@1'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'app', 'templatetags')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
                'app.context_processors.theme_cookie',
